...
import torch
from src.data.make_dataset import PurePropData
...
model = AttentiveFP(in_channels=in_channel, hidden_channels=hidden_channels, out_channels=out_channel,
                    edge_dim=edge_dim, num_layers=num_layers, num_timesteps=num_timesteps,
